...
export function analyzeRegulation(params: {
  ...
  return {
    ...
    notice:
      "본 결과는 교육청 체크리스트 15개 항목, 연수자료, 초·중등교육법, 초·중등교육법 시행령, 교원의 학생생활지도에 관한 고시를 근거로 하며, AI 개정안 초안은 모산초등학교 학교생활규정 확정안의 조항 표현을 참고한 검토 보조 결과입니다. PDF 추출 결과는 조항 순서가 섞일 수 있으므로 최종 개정안은 학교 절차에 따라 담당자가 확인해야 합니다.",
  };
}
